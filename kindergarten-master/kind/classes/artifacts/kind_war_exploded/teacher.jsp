...
<%
		...
		String message3 = (String)sess.getAttribute("message3");

	

	if(message3 == ""||message3 == null){
...
<div id="content">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a href="TeacherServlet1/select?wx=0">全部</a></li>
            <li><a href="TeacherServlet1/select?wx=1">推送</a></li>
            <li><a href="TeacherServlet1/select?wx=2">未推送</a></li>
        </ul>
    </div>
    ...
    <table id="customer" class="table table-bordered">
        ...
        <tr>
          ...
          <tbody>
        <c:forEach items="${ter}" var="ter">
        <tr>
            <td onselectstart="return false" onselect="document.selection.empty()" style="text-align: center; vertical-align: middle"><label class="checkbox"><input type="checkbox"  name="id" value="${ter.id}"/>${ter.id}</label></td>
            <td style="text-align: center; vertical-align: middle"  width="500px"><div class="teacher_image"><img src="${ter.imgurl}"></div><div class="teacher_words"><textarea  style="width:200px;height:90px;" name="bigdec" readonly>    ${ter.bigdec}</textarea></div></td>
            <td onselectstart="return false" onselect="document.selection.empty()"style="text-align: center; vertical-align: middle">${ter.timeing}</td>
            <td onselectstart="return false" onselect="document.selection.empty()" style="text-align: center; vertical-align: middle">
                           <c:if test="${ter.wx eq'1'}">是</c:if> 
                            <c:if test="${ter.wx eq'2'}">否</c:if>
        
            </td>
            <td onselectstart="return false" onselect="document.selection.empty()" style="text-align: center; vertical-align: middle">
                  <a href="TeacherServlet1/selectbean?id=${ter.id}" class="btn btn-warning">修改</a>
    ...
    <div id="layer" style="width: 950px;height: 450px;background-color: white">
	    <form class="form-horizontal" style="margin-top: 50px" action="TeacherServlet1/addtext" method="post" enctype="multipart/form-data">
	        <legend>&nbsp;&nbsp;&nbsp;&nbsp;添加教师风采：</legend>
    ...
    $(function() {
        ...
        $("#deleteAll").click(function(){
            ...
            if(deleteAll.length==0){
                ...
                //提交
                window.location.href="TeacherServlet1/delete?arrId="+arrId;
            }
