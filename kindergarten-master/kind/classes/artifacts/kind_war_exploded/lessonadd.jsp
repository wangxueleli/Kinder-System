	...
	<form  method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-6" >
				<select  class="input-text aaaa"  onchange="weektime(this)"  id="week" name="week">
				<option>请选择</option>
				<option>1</option>
				<option>2</option>
				<option>3</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-6">
				<select type="text" class="input-text"  onchange="pootime(this)"  placeholder="" id="potime" name="potime">>
				<option>请选择</option>
				<option>1</option>
				<option>2</option>
				<option>3</option>
