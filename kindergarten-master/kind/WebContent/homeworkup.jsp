...
<div id="content">
    <div id="breadcrumb">
        ...
        <a href="homework.jsp" class="current">幼儿作品</a>
    </div>

	
	<div>
	            <form class="form-horizontal" style="margin-top: 50px" action="HomeworkServlet/update" method="post">
	          <legend>&nbsp;&nbsp;&nbsp;&nbsp;幼儿作品：</legend>
	          <div class="teacher_image" style="margin-left: 80px;"><img src="${homework.imgurl}"></div>
	        ...
	        <div class="control-group">
	            ...
	            <div class="controls">
	                <div class="textarea">
	                    <textarea style="height:80px" type="" name="bigdec" required="required">${homework.bigdec} </textarea>
	                </div>
	            </div>
	        </div>
	        <div class="control-group">
	            ...
	            <div class="controls">
	                ...
	                <label class="radio inline">
	                    <input name="wx" type="radio" <c:if test="${homework.wx eq'1'}">checked</c:if>  value="1">
	                    是
	                </label>
	                &nbsp;
	                <label class="radio inline">
	                    <input name="wx" type="radio" <c:if test="${homework.wx eq'2'}">checked</c:if> value="2">
	                    否
	                </label>
	            </div>
	        </div>
	        <div class="control-group">
	            ...
	            <div class="controls">
	                ...
	                <a class="btn" href="homework.jsp">取消</a>
	            </div>
	        </div>
	    </form>
	</div>      
