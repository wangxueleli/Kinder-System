...
<div id="content">
	...
	<div>
	            <form class="form-horizontal" style="margin-top: 50px" action="CertificateServlet/update" method="post">
	          <legend>&nbsp;&nbsp;&nbsp;&nbsp;校园荣誉：</legend>
	          <div class="teacher_image" style="margin-left: 80px;"><img src="${ccate.imgurl}"></div>
	         <input name="id" type="hidden" value="${ccate.id}">
	        <div class="control-group">
	            ...
	            <div class="controls">
	                <div class="textarea">
	                    <textarea style="height:80px" type="" name="bigdec" required="required">${ccate.bigdec} </textarea>
	                </div>
	            </div>
	        </div>
	        <div class="control-group">
	            ...
	            <div class="controls">
	                ...
	                <label class="radio inline">
	                    <input name="wx" type="radio" <c:if test="${ccate.wx eq'1'}">checked</c:if>  value="1">
	                    是
	                </label>
	                &nbsp;
	                <label class="radio inline">
	                    <input name="wx" type="radio" <c:if test="${ccate.wx eq'2'}">checked</c:if> value="2">
	                    否
	                </label>
	            </div>
	        </div>
	        <div class="control-group">
	            ...
	            <div class="controls">
	                ...
	                <a class="btn" href="winner.jsp">取消</a>
	            </div>
	        </div>
	    </form>
	</div>      
